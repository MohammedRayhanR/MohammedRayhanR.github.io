      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <Link href="/" className="flex items-center">
            ...
            <span className="text-xl font-bold text-slate-800">ServerEd</span>
          </Link>
          ...
          {isMobileMenuOpen && (
            ...
            >
              <div className="py-4 space-y-2">
                <button
                  onClick={() => scrollToSection("home")}
                  className="block w-full text-left px-4 py-2 text-slate-600 hover:text-primary hover:bg-slate-50 transition-colors duration-200"
                >
                  Home
                </button>
                <button
