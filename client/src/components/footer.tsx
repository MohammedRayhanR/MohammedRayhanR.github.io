        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <span className="text-slate-400">support@servered.com</span>
              </div>
              <div className="flex items-center">
              ...
              <div className="flex items-center">
                <MapPin className="text-slate-500 mr-3" size={16} />
          ...
          <div>
            ...
            <div className="space-y-2">
              <a href="#" className="block text-slate-400 hover:text-primary transition-colors">Documentation</a>
              <a href="#" className="block text-slate-400 hover:text-primary transition-colors">Community</a>
              <a href="#" className="block text-slate-400 hover:text-primary transition-colors">Blog</a>
              <a href="#" className="block text-slate-400 hover:text-primary transition-colors">Support</a>
            </div>
          </div>
        </div>
